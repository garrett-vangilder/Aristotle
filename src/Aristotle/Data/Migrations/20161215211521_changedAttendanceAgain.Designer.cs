...
namespace Aristotle.Data.Migrations
{
    ...
    [Migration("20161215211521_changedAttendanceAgain")]
    partial class changedAttendanceAgain
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Aristotle.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Aristotle.Models.ApplicationUser")
                        .WithMany("Claims")
